...
class BaseManager(Generic[_T, _QS]):
    ...
    @classmethod
    def from_queryset(cls, queryset_class: type[_QS], class_name: str | None = None) -> type[Self]: ...
    @classmethod
...
class Manager(BaseManager[_T, _QS]):
    ...
    def union(self, *other_qs: Any, all: bool = ...) -> _QS: ...
    def intersection(self, *other_qs: Any) -> _QS: ...
    def difference(self, *other_qs: Any) -> _QS: ...
