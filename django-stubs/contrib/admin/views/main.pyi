...
class ChangeList:
    ...
    def get_ordering(self, request: HttpRequestUser, queryset: QuerySet[Any]) -> list[_OrderByFieldName]: ...
    def get_ordering_field_columns(self) -> dict[int, Literal["desc", "asc"]]: ...
    def get_queryset(
        self, request: HttpRequestUser, exclude_parameters: list[str | None] | None = ...
    ) -> QuerySet[Any]: ...
