...
class ChangeList:
    ...
    def get_filters(self, request: HttpRequestUser) -> tuple[list[ListFilter], bool, dict[str, bool | str], bool, bool]: ...
    ...
    multi_page: bool
    paginator: Any
    def get_results(self, request: HttpRequestUser) -> None: ...
    def get_ordering_field(self, field_name: Callable | str) -> _OrderByFieldName | None: ...
    def get_ordering(self, request: HttpRequestUser, queryset: QuerySet) -> list[_OrderByFieldName]: ...
    def get_ordering_field_columns(self) -> dict[int, Literal["desc", "asc"]]: ...
    def get_queryset(self, request: HttpRequestUser, exclude_parameters: list[str | None] | None = ...) -> QuerySet: ...
